...
export default function Register() {
    ...
    const isFormValid = data.username.trim() && data.email.trim() && data.password.trim();
            ...
            <div className="min-h-screen bg-white flex flex-col font-sans">
                ...
                <main className="flex-1 flex flex-col items-center justify-center px-4 py-12">
                    ...
                    <p className="text-neutral-950 text-sm mb-6 text-center">
                        Daftar dan mulai kelola eventmu.
                    </p>
                    ...
                    <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl p-4 shadow-sm">
                        ...
                        <p className="text-center text-sm text-gray-500 mt-6">
                            Sudah punya akun?{' '}
                            <Link href={route('login')} className="text-sky-500 font-semibold hover:text-sky-600">
                                Masuk
                            </Link>
                        </p>
                    </div>
