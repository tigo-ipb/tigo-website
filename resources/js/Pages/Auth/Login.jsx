                    ...
                    <div className="w-full max-w-md bg-white border border-gray-200 rounded-3xl p-4 shadow-sm">
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-gray-300 text-sky-500 ring-1 ring-neutral-300"
                                    />
                            ...
                            <button
                                ...
                                className={`w-full py-3 bg-sky-500 text-white font-semibold rounded-xl transition-colors text-sm ${(processing || !data.email.trim() || !data.password.trim())
                        ...
                        <div className="flex items-center my-4">
                            ...
                            <span className="px-4 text-xs font-regular text-neutral-950">atau</span>
                            <div className="flex-1 border-t border-neutral-300"></div>
                        </div>
                        ...
                        <a
                            ...
                            className="w-full flex items-center justify-center gap-2 py-3 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-semibold rounded-xl transition-colors text-sm"
                        >
                        ...
                        <p className="text-center text-sm text-gray-500 mt-6">
                            Belum punya akun?{' '}
                            <Link href={route('register')} className="text-sky-500 font-semibold hover:text-sky-600">
                                Buat akun
                            </Link>
                        </p>
                    </div>
