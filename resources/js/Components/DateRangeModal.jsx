          ...
          <div className="bg-sky-50 border border-sky-500 rounded-[16px] flex justify-center w-full md:w-max p-2 md:p-3 mx-auto">
            <Calendar
              ...
              classNames={{
                ...
                // Ubah warna highlight background cell yang terpilih
                cell: "text-center text-sm p-0 relative [&:has([aria-selected])]:bg-sky-100! first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 w-9 h-9 md:w-10 md:h-10",
                // Ubah hover state hari
                ...
                range_middle: "aria-selected:bg-sky-100 aria-selected:text-black aria-selected:rounded-none",
                range_start: "bg-sky-500 aria-selected:bg-sky-500 text-white rounded-md rounded-r-none font-bold",
                range_end: "day-range-end bg-sky-500 aria-selected:bg-sky-500 text-white rounded-md rounded-l-none font-bold",
                outside: "opacity-25",
