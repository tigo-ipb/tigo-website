    ...
    return (
        <div className={`w-full bg-white border border-neutral-300 rounded-[24px] px-4 py-4 shadow-sm flex items-center justify-between gap-4 font-sans mt-auto shrink-0`}>
            ...
            <a
                ...
                className="w-6 h-6 sm:w-8 sm:h-8 rounded-[8px] flex items-center justify-center bg-sky-100 text-sky-500 hover:bg-sky-200 hover:text-sky-600 hover:scale-105 transition-all shadow-sm shrink-0 border border-sky-100/50 cursor-pointer"
